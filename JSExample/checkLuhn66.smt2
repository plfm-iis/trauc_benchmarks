...
(assert (= i11 (+ i10 (- 2))))
(assert (= d11 (str.to.int (str.at value0 i11))))
(assert (= sum12 (+ sum11 (ite (> (* d11 2) 9) (+ (* d11 2) (- 9)) (* d11 2)))))
(assert (= last0 (str.at (int.to.str sum12) (+ (str.len (int.to.str sum12)) (- 1)))))
(assert (= last0 "0"))
(check-sat)
(get-model)
