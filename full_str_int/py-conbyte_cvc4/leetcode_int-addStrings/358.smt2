...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  ) ( - ( str.to.int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 5)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  )  ) 0  ) 10  ))
