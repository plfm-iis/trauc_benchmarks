...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num1 ( + ( str.len num1  ) (- 6)  )  )  ) ( - ( str.to.int ( str.substr ( str.at num1 ( + ( str.len num1  ) (- 6)  )  ) 1 ( - ( str.len ( str.at num1 ( + ( str.len num1  ) (- 6)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 6)  )  )  )  ) 0  ) 10  ))
