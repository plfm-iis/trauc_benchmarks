...
(assert ( <= ( ite ( str.prefixof "-" ( str.substr dtstr 8 ( - 10 8  )  )  ) ( - ( str.to.int ( str.substr ( str.substr dtstr 8 ( - 10 8  )  ) 1 ( - ( str.len ( str.substr dtstr 8 ( - 10 8  )  )  ) 1  )  )  )  ) ( str.to.int ( str.substr dtstr 8 ( - 10 8  )  )  )  ) 0  ))
