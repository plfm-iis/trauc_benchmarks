...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num1 ( + ( str.len num1  ) (- 4)  )  )  ) ( - ( str.to.int ( str.substr ( str.at num1 ( + ( str.len num1  ) (- 4)  )  ) 1 ( - ( str.len ( str.at num1 ( + ( str.len num1  ) (- 4)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 4)  )  )  )  ) 0  ) 10  ))
