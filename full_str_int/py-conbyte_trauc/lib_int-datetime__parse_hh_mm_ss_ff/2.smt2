...
(assert ( < ( ite ( str.prefixof "-" ( str.substr tstr ( + ( + 0 2  ) 1  ) ( - ( + ( + ( + 0 2  ) 1  ) 2  ) ( + ( + 0 2  ) 1  )  )  )  ) ( - ( str.to.int ( str.substr ( str.substr tstr ( + ( + 0 2  ) 1  ) ( - ( + ( + ( + 0 2  ) 1  ) 2  ) ( + ( + 0 2  ) 1  )  )  ) 1 ( - ( str.len ( str.substr tstr ( + ( + 0 2  ) 1  ) ( - ( + ( + ( + 0 2  ) 1  ) 2  ) ( + ( + 0 2  ) 1  )  )  )  ) 1  )  )  )  ) ( str.to.int ( str.substr tstr ( + ( + 0 2  ) 1  ) ( - ( + ( + ( + 0 2  ) 1  ) 2  ) ( + ( + 0 2  ) 1  )  )  )  )  ) 0  ))
