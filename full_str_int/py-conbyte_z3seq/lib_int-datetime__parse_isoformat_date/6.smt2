...
(assert ( < ( ite ( str.prefixof "-" ( str.substr dtstr 0 ( - 4 0  )  )  ) ( - ( str.to.int ( str.substr ( str.substr dtstr 0 ( - 4 0  )  ) 1 ( - ( str.len ( str.substr dtstr 0 ( - 4 0  )  )  ) 1  )  )  )  ) ( str.to.int ( str.substr dtstr 0 ( - 4 0  )  )  )  ) 0  ))
