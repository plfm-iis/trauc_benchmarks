...
(assert ( > ( ite ( str.prefixof "-" ( str.substr IP 0 ( - ( str.indexof IP "." 0  ) 0  )  )  ) ( - ( str.to.int ( str.substr ( str.substr IP 0 ( - ( str.indexof IP "." 0  ) 0  )  ) 1 ( - ( str.len ( str.substr IP 0 ( - ( str.indexof IP "." 0  ) 0  )  )  ) 1  )  )  )  ) ( str.to.int ( str.substr IP 0 ( - ( str.indexof IP "." 0  ) 0  )  )  )  ) 255  ))
