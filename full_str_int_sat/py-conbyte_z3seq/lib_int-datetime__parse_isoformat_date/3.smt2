...
(assert ( > ( ite ( str.prefixof "-" ( str.substr dtstr 5 ( - 7 5  )  )  ) ( - ( str.to.int ( str.substr ( str.substr dtstr 5 ( - 7 5  )  ) 1 ( - ( str.len ( str.substr dtstr 5 ( - 7 5  )  )  ) 1  )  )  )  ) ( str.to.int ( str.substr dtstr 5 ( - 7 5  )  )  )  ) 12  ))
