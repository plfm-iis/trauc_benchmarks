...
(assert (not ( str.in.re ( str.substr ( str.substr IP ( + ( str.indexof IP "." 0  ) 1  ) ( - ( str.len IP  ) ( + ( str.indexof IP "." 0  ) 1  )  )  ) 0 ( - ( str.indexof ( str.substr IP ( + ( str.indexof IP "." 0  ) 1  ) ( - ( str.len IP  ) ( + ( str.indexof IP "." 0  ) 1  )  )  ) "." 0  ) 0  )  ) ( re.+ ( re.range "0" "9"  )  )  )))
