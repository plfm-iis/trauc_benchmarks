...
(assert (not ( >= ( + ( + 0 ( ite ( str.prefixof "-" ( str.at a ( + ( str.len a  ) (- 6)  )  )  ) ( - ( str.to.int ( str.substr ( str.at a ( + ( str.len a  ) (- 6)  )  ) 1 ( - ( str.len ( str.at a ( + ( str.len a  ) (- 6)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 6)  )  )  )  )  ) ( ite ( str.prefixof "-" ( str.at b ( + ( str.len b  ) (- 6)  )  )  ) ( - ( str.to.int ( str.substr ( str.at b ( + ( str.len b  ) (- 6)  )  ) 1 ( - ( str.len ( str.at b ( + ( str.len b  ) (- 6)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at b ( + ( str.len b  ) (- 6)  )  )  )  )  ) 2  )))
