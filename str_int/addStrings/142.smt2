...
(assert ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  ) ( ite ( = (- 1) ( str.to.int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 3)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  ) 1  )  )  )  ) false true  ) ( ite ( = (- 1) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  )  ) false true  )  ))
...
(assert ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) ( ite ( = (- 1) ( str.to.int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 2)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) 1  )  )  )  ) false true  ) ( ite ( = (- 1) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  )  ) false true  )  ))
...
(assert ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  ) ( ite ( = (- 1) ( str.to.int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 1)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  ) 1  )  )  )  ) false true  ) ( ite ( = (- 1) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  )  ) false true  )  ))
