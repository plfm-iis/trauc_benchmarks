...
(assert ( >= ( + ( str.len a  ) (- 1)  ) 0  ))
(assert ( >= ( + 0 ( ite ( str.prefixof "-" ( str.at a ( + ( str.len a  ) (- 4)  )  )  ) ( - ( str.to.int ( str.substr ( str.at a ( + ( str.len a  ) (- 4)  )  ) 1 ( - ( str.len ( str.at a ( + ( str.len a  ) (- 4)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 4)  )  )  )  )  ) 2  ))
