...
(assert ( ite ( str.prefixof "-" ( str.at a ( + ( str.len a  ) (- 6)  )  )  ) ( ite ( = (- 1) ( str.to.int ( str.substr ( str.at a ( + ( str.len a  ) (- 6)  )  ) 1 ( - ( str.len ( str.at a ( + ( str.len a  ) (- 6)  )  )  ) 1  )  )  )  ) false true  ) ( ite ( = (- 1) ( str.to.int ( str.at a ( + ( str.len a  ) (- 6)  )  )  )  ) false true  )  ))
...
(assert (not ( >= ( + 0 ( ite ( str.prefixof "-" ( str.at a ( + ( str.len a  ) (- 2)  )  )  ) ( - ( str.to.int ( str.substr ( str.at a ( + ( str.len a  ) (- 2)  )  ) 1 ( - ( str.len ( str.at a ( + ( str.len a  ) (- 2)  )  )  ) 1  )  )  )  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 2)  )  )  )  )  ) 2  )))
