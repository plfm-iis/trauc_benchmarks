...
(assert ( not ( = ( str.at word 2  ) ( str.at abbr 0  )  )  ))
...
(assert ( < 0 ( str.len abbr  )  ))
(assert ( >= ( + ( + ( + 0 ( + ( * 0 10  ) ( ite ( str.prefixof "-" ( str.at abbr 0  )  ) ( - ( str.to.int ( str.substr ( str.at abbr 0  ) 1 ( - ( str.len ( str.at abbr 0  )  ) 1  )  )  )  ) ( str.to.int ( str.at abbr 0  )  )  )  )  ) 1  ) 0  ) ( str.len word  )  ))
